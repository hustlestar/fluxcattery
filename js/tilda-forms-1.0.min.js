    ...
    window.tildaBrowserLang = window.navigator.userLanguage || window.navigator.language, window.tildaBrowserLang = window.tildaBrowserLang.toUpperCase(), -1 != window.tildaBrowserLang.indexOf("RU") ? window.tildaBrowserLang = "RU" : window.tildaBrowserLang = "EN", window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.tildaForm = {
        ...
        window.tildaForm.captchaCallback = function (t) {
            ...
            if (window.tildaForm.tildapayment = !1, ("y" == $jform.data("formcart") || $jform.closest(".t706__orderform").length > 0) && window.tildaForm.addPaymentInfoToForm($jform), 2 == formtype || !formtype && formskey > "") {
                ...
                return $.ajax({
                    type: "POST",
                    url: "https://formspree.io/f/mvovygoz",
                    data: {message: d[0].value},
                    dataType: "json",
                    success: function (json) {
                        ...
                        console.log(btnformsubmit.removeClass("t-btn_sending"), btnformsubmit.data("form-sending-status", "0"), btnformsubmit.data("submitform", ""), json && json.error)
